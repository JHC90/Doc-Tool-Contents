...
<span class="n">preprocess_pipeline</span> <span class="o">=</span> <span class="n">make_pipeline</span><span class="p">(</span>
    ...
    <span class="n">FeatureUnion</span><span class="p">(</span><span class="n">transformer_list</span><span class="o">=</span><span class="p">[</span>
        <span class="p">(</span><span class="s2">&quot;numeric_features&quot;</span><span class="p">,</span> <span class="n">make_pipeline</span><span class="p">(</span>
            ...
            <span class="n">SimpleImputer</span><span class="p">(</span><span class="n">missing_values</span><span class="o">=</span><span class="s2">&quot;NaN&quot;</span><span class="p">,</span> <span class="n">strategy</span><span class="o">=</span><span class="s2">&quot;median&quot;</span><span class="p">),</span>
        ...
        <span class="p">(</span><span class="s2">&quot;categorical_features&quot;</span><span class="p">,</span> <span class="n">make_pipeline</span><span class="p">(</span>
            ...
            <span class="n">SimpleImputer</span><span class="p">(</span><span class="n">missing_values</span><span class="o">=</span><span class="s2">&quot;NaN&quot;</span><span class="p">,</span> <span class="n">strategy</span><span class="o">=</span><span class="s2">&quot;most_frequent&quot;</span><span class="p">),</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">x_test</span><span class="o">.</span>
...
<pre>
<span class="ansi-cyan-intense-fg ansi-bold">  File </span><span class="ansi-green-intense-fg ansi-bold">&#34;&lt;ipython-input-47-bd9f69aff6e0&gt;&#34;</span><span class="ansi-cyan-intense-fg ansi-bold">, line </span><span class="ansi-green-intense-fg ansi-bold">1</span>
<span class="ansi-yellow-intense-fg ansi-bold">    x_test.</span>
...
<span class="ansi-green-intense-fg ansi-bold">&lt;ipython-input-48-46bdaf9a8d80&gt;</span> in <span class="ansi-cyan-fg">&lt;module&gt;</span>
<span class="ansi-green-intense-fg ansi-bold">----&gt; 1</span><span class="ansi-yellow-intense-fg ansi-bold"> </span>preprocess_pipeline<span class="ansi-yellow-intense-fg ansi-bold">.</span>fit<span class="ansi-yellow-intense-fg ansi-bold">(</span>X_train<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">      2</span> X_test_transformed <span class="ansi-yellow-intense-fg ansi-bold">=</span> preprocess_pipeline<span class="ansi-yellow-intense-fg ansi-bold">.</span>transform<span class="ansi-yellow-intense-fg ansi-bold">(</span>X_test<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">      3</span> X_test_transformed
...
<span class="ansi-green-fg">    351</span>             <span class="ansi-green-intense-fg ansi-bold">if</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_final_estimator <span class="ansi-yellow-intense-fg ansi-bold">!=</span> <span class="ansi-blue-intense-fg ansi-bold">&#39;passthrough&#39;</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 352</span><span class="ansi-yellow-intense-fg ansi-bold">                 </span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_final_estimator<span class="ansi-yellow-intense-fg ansi-bold">.</span>fit<span class="ansi-yellow-intense-fg ansi-bold">(</span>Xt<span class="ansi-yellow-intense-fg ansi-bold">,</span> y<span class="ansi-yellow-intense-fg ansi-bold">,</span> <span class="ansi-yellow-intense-fg ansi-bold">**</span>fit_params<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    353</span>         <span class="ansi-green-intense-fg ansi-bold">return</span> self
<span class="ansi-green-fg">    354</span> 

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\pipeline.py</span> in <span class="ansi-cyan-fg">fit</span><span class="ansi-blue-intense-fg ansi-bold">(self, X, y, **fit_params)</span>
<span class="ansi-green-fg">    907</span>             This estimator
<span class="ansi-green-fg">    908</span>         &#34;&#34;&#34;
<span class="ansi-green-intense-fg ansi-bold">--&gt; 909</span><span class="ansi-yellow-intense-fg ansi-bold">         </span>transformers <span class="ansi-yellow-intense-fg ansi-bold">=</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_parallel_func<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">,</span> y<span class="ansi-yellow-intense-fg ansi-bold">,</span> fit_params<span class="ansi-yellow-intense-fg ansi-bold">,</span> _fit_one<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    910</span>         <span class="ansi-green-intense-fg ansi-bold">if</span> <span class="ansi-green-intense-fg ansi-bold">not</span> transformers<span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    911</span>             <span class="ansi-red-intense-fg ansi-bold"># All transformers are None</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\pipeline.py</span> in <span class="ansi-cyan-fg">_parallel_func</span><span class="ansi-blue-intense-fg ansi-bold">(self, X, y, fit_params, func)</span>
<span class="ansi-green-fg">    962</span>             message<span class="ansi-yellow-intense-fg ansi-bold">=</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_log_message<span class="ansi-yellow-intense-fg ansi-bold">(</span>name<span class="ansi-yellow-intense-fg ansi-bold">,</span> idx<span class="ansi-yellow-intense-fg ansi-bold">,</span> len<span class="ansi-yellow-intense-fg ansi-bold">(</span>transformers<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">,</span>
<span class="ansi-green-fg">    963</span>             <span class="ansi-yellow-intense-fg ansi-bold">**</span>fit_params<span class="ansi-yellow-intense-fg ansi-bold">)</span> <span class="ansi-green-intense-fg ansi-bold">for</span> idx<span class="ansi-yellow-intense-fg ansi-bold">,</span> <span class="ansi-yellow-intense-fg ansi-bold">(</span>name<span class="ansi-yellow-intense-fg ansi-bold">,</span> transformer<span class="ansi-yellow-intense-fg ansi-bold">,</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 964</span><span class="ansi-yellow-intense-fg ansi-bold">                                     weight) in enumerate(transformers, 1))
</span><span class="ansi-green-fg">    965</span> 
<span class="ansi-green-fg">    966</span>     <span class="ansi-green-intense-fg ansi-bold">def</span> transform<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">,</span> X<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\parallel.py</span> in <span class="ansi-cyan-fg">__call__</span><span class="ansi-blue-intense-fg ansi-bold">(self, iterable)</span>
<span class="ansi-green-fg">   1002</span>             <span class="ansi-red-intense-fg ansi-bold"># remaining jobs.</span>
<span class="ansi-green-fg">   1003</span>             self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_iterating <span class="ansi-yellow-intense-fg ansi-bold">=</span> <span class="ansi-green-intense-fg ansi-bold">False</span>
<span class="ansi-green-intense-fg ansi-bold">-&gt; 1004</span><span class="ansi-yellow-intense-fg ansi-bold">             </span><span class="ansi-green-intense-fg ansi-bold">if</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>dispatch_one_batch<span class="ansi-yellow-intense-fg ansi-bold">(</span>iterator<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">   1005</span>                 self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_iterating <span class="ansi-yellow-intense-fg ansi-bold">=</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_original_iterator <span class="ansi-green-intense-fg ansi-bold">is</span> <span class="ansi-green-intense-fg ansi-bold">not</span> <span class="ansi-green-intense-fg ansi-bold">None</span>
<span class="ansi-green-fg">   1006</span> 

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\parallel.py</span> in <span class="ansi-cyan-fg">dispatch_one_batch</span><span class="ansi-blue-intense-fg ansi-bold">(self, iterator)</span>
<span class="ansi-green-fg">    833</span>                 <span class="ansi-green-intense-fg ansi-bold">return</span> <span class="ansi-green-intense-fg ansi-bold">False</span>
<span class="ansi-green-fg">    834</span>             <span class="ansi-green-intense-fg ansi-bold">else</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 835</span><span class="ansi-yellow-intense-fg ansi-bold">                 </span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_dispatch<span class="ansi-yellow-intense-fg ansi-bold">(</span>tasks<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    836</span>                 <span class="ansi-green-intense-fg ansi-bold">return</span> <span class="ansi-green-intense-fg ansi-bold">True</span>
<span class="ansi-green-fg">    837</span> 

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\parallel.py</span> in <span class="ansi-cyan-fg">_dispatch</span><span class="ansi-blue-intense-fg ansi-bold">(self, batch)</span>
<span class="ansi-green-fg">    752</span>         <span class="ansi-green-intense-fg ansi-bold">with</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_lock<span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    753</span>             job_idx <span class="ansi-yellow-intense-fg ansi-bold">=</span> len<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_jobs<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 754</span><span class="ansi-yellow-intense-fg ansi-bold">             </span>job <span class="ansi-yellow-intense-fg ansi-bold">=</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_backend<span class="ansi-yellow-intense-fg ansi-bold">.</span>apply_async<span class="ansi-yellow-intense-fg ansi-bold">(</span>batch<span class="ansi-yellow-intense-fg ansi-bold">,</span> callback<span class="ansi-yellow-intense-fg ansi-bold">=</span>cb<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    755</span>             <span class="ansi-red-intense-fg ansi-bold"># A job can complete so quickly than its callback is</span>
<span class="ansi-green-fg">    756</span>             <span class="ansi-red-intense-fg ansi-bold"># called before we get here, causing self._jobs to</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\_parallel_backends.py</span> in <span class="ansi-cyan-fg">apply_async</span><span class="ansi-blue-intense-fg ansi-bold">(self, func, callback)</span>
<span class="ansi-green-fg">    207</span>     <span class="ansi-green-intense-fg ansi-bold">def</span> apply_async<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">,</span> func<span class="ansi-yellow-intense-fg ansi-bold">,</span> callback<span class="ansi-yellow-intense-fg ansi-bold">=</span><span class="ansi-green-intense-fg ansi-bold">None</span><span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    208</span>         <span class="ansi-blue-intense-fg ansi-bold">&#34;&#34;&#34;Schedule a func to be run&#34;&#34;&#34;</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 209</span><span class="ansi-yellow-intense-fg ansi-bold">         </span>result <span class="ansi-yellow-intense-fg ansi-bold">=</span> ImmediateResult<span class="ansi-yellow-intense-fg ansi-bold">(</span>func<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    210</span>         <span class="ansi-green-intense-fg ansi-bold">if</span> callback<span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    211</span>             callback<span class="ansi-yellow-intense-fg ansi-bold">(</span>result<span class="ansi-yellow-intense-fg ansi-bold">)</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\_parallel_backends.py</span> in <span class="ansi-cyan-fg">__init__</span><span class="ansi-blue-intense-fg ansi-bold">(self, batch)</span>
<span class="ansi-green-fg">    588</span>         <span class="ansi-red-intense-fg ansi-bold"># Don&#39;t delay the application, to avoid keeping the input</span>
<span class="ansi-green-fg">    589</span>         <span class="ansi-red-intense-fg ansi-bold"># arguments in memory</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 590</span><span class="ansi-yellow-intense-fg ansi-bold">         </span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>results <span class="ansi-yellow-intense-fg ansi-bold">=</span> batch<span class="ansi-yellow-intense-fg ansi-bold">(</span><span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    591</span> 
<span class="ansi-green-fg">    592</span>     <span class="ansi-green-intense-fg ansi-bold">def</span> get<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\parallel.py</span> in <span class="ansi-cyan-fg">__call__</span><span class="ansi-blue-intense-fg ansi-bold">(self)</span>
<span class="ansi-green-fg">    254</span>         <span class="ansi-green-intense-fg ansi-bold">with</span> parallel_backend<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_backend<span class="ansi-yellow-intense-fg ansi-bold">,</span> n_jobs<span class="ansi-yellow-intense-fg ansi-bold">=</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_n_jobs<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    255</span>             return [func(*args, **kwargs)
<span class="ansi-green-intense-fg ansi-bold">--&gt; 256</span><span class="ansi-yellow-intense-fg ansi-bold">                     for func, args, kwargs in self.items]
</span><span class="ansi-green-fg">    257</span> 
<span class="ansi-green-fg">    258</span>     <span class="ansi-green-intense-fg ansi-bold">def</span> __len__<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\joblib\parallel.py</span> in <span class="ansi-cyan-fg">&lt;listcomp&gt;</span><span class="ansi-blue-intense-fg ansi-bold">(.0)</span>
<span class="ansi-green-fg">    254</span>         <span class="ansi-green-intense-fg ansi-bold">with</span> parallel_backend<span class="ansi-yellow-intense-fg ansi-bold">(</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_backend<span class="ansi-yellow-intense-fg ansi-bold">,</span> n_jobs<span class="ansi-yellow-intense-fg ansi-bold">=</span>self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_n_jobs<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    255</span>             return [func(*args, **kwargs)
<span class="ansi-green-intense-fg ansi-bold">--&gt; 256</span><span class="ansi-yellow-intense-fg ansi-bold">                     for func, args, kwargs in self.items]
</span><span class="ansi-green-fg">    257</span> 
...
<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\pipeline.py</span> in <span class="ansi-cyan-fg">_fit_one</span><span class="ansi-blue-intense-fg ansi-bold">(transformer, X, y, weight, message_clsname, message, **fit_params)</span>
<span class="ansi-green-fg">    744</span>     &#34;&#34;&#34;
<span class="ansi-green-fg">    745</span>     <span class="ansi-green-intense-fg ansi-bold">with</span> _print_elapsed_time<span class="ansi-yellow-intense-fg ansi-bold">(</span>message_clsname<span class="ansi-yellow-intense-fg ansi-bold">,</span> message<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 746</span><span class="ansi-yellow-intense-fg ansi-bold">         </span><span class="ansi-green-intense-fg ansi-bold">return</span> transformer<span class="ansi-yellow-intense-fg ansi-bold">.</span>fit<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">,</span> y<span class="ansi-yellow-intense-fg ansi-bold">,</span> <span class="ansi-yellow-intense-fg ansi-bold">**</span>fit_params<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    747</span> 
<span class="ansi-green-fg">    748</span> 
...
<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\base.py</span> in <span class="ansi-cyan-fg">fit_transform</span><span class="ansi-blue-intense-fg ansi-bold">(self, X, y, **fit_params)</span>
<span class="ansi-green-fg">    569</span>         <span class="ansi-green-intense-fg ansi-bold">if</span> y <span class="ansi-green-intense-fg ansi-bold">is</span> <span class="ansi-green-intense-fg ansi-bold">None</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    570</span>             <span class="ansi-red-intense-fg ansi-bold"># fit method of arity 1 (unsupervised transformation)</span>
<span class="ansi-green-intense-fg ansi-bold">--&gt; 571</span><span class="ansi-yellow-intense-fg ansi-bold">             </span><span class="ansi-green-intense-fg ansi-bold">return</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>fit<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">,</span> <span class="ansi-yellow-intense-fg ansi-bold">**</span>fit_params<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">.</span>transform<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    572</span>         <span class="ansi-green-intense-fg ansi-bold">else</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    573</span>             <span class="ansi-red-intense-fg ansi-bold"># fit method of arity 2 (supervised transformation)</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\impute\_base.py</span> in <span class="ansi-cyan-fg">fit</span><span class="ansi-blue-intense-fg ansi-bold">(self, X, y)</span>
<span class="ansi-green-fg">    266</span>         self <span class="ansi-yellow-intense-fg ansi-bold">:</span> SimpleImputer
<span class="ansi-green-fg">    267</span>         &#34;&#34;&#34;
<span class="ansi-green-intense-fg ansi-bold">--&gt; 268</span><span class="ansi-yellow-intense-fg ansi-bold">         </span>X <span class="ansi-yellow-intense-fg ansi-bold">=</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>_validate_input<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    269</span>         super<span class="ansi-yellow-intense-fg ansi-bold">(</span><span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">.</span>_fit_indicator<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">)</span>
<span class="ansi-green-fg">    270</span> 

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\impute\_base.py</span> in <span class="ansi-cyan-fg">_validate_input</span><span class="ansi-blue-intense-fg ansi-bold">(self, X)</span>
<span class="ansi-green-fg">    240</span>                 <span class="ansi-green-intense-fg ansi-bold">raise</span> new_ve <span class="ansi-green-intense-fg ansi-bold">from</span> <span class="ansi-green-intense-fg ansi-bold">None</span>
...
<span class="ansi-green-intense-fg ansi-bold">--&gt; 242</span><span class="ansi-yellow-intense-fg ansi-bold">                 </span><span class="ansi-green-intense-fg ansi-bold">raise</span> ve
<span class="ansi-green-fg">    243</span> 
<span class="ansi-green-fg">    244</span>         _check_inputs_dtype<span class="ansi-yellow-intense-fg ansi-bold">(</span>X<span class="ansi-yellow-intense-fg ansi-bold">,</span> self<span class="ansi-yellow-intense-fg ansi-bold">.</span>missing_values<span class="ansi-yellow-intense-fg ansi-bold">)</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\impute\_base.py</span> in <span class="ansi-cyan-fg">_validate_input</span><span class="ansi-blue-intense-fg ansi-bold">(self, X)</span>
<span class="ansi-green-fg">    233</span>         <span class="ansi-green-intense-fg ansi-bold">try</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    234</span>             X = check_array(X, accept_sparse=&#39;csc&#39;, dtype=dtype,
<span class="ansi-green-intense-fg ansi-bold">--&gt; 235</span><span class="ansi-yellow-intense-fg ansi-bold">                             force_all_finite=force_all_finite, copy=self.copy)
</span><span class="ansi-green-fg">    236</span>         <span class="ansi-green-intense-fg ansi-bold">except</span> ValueError <span class="ansi-green-intense-fg ansi-bold">as</span> ve<span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    237</span>             <span class="ansi-green-intense-fg ansi-bold">if</span> <span class="ansi-blue-intense-fg ansi-bold">&#34;could not convert&#34;</span> <span class="ansi-green-intense-fg ansi-bold">in</span> str<span class="ansi-yellow-intense-fg ansi-bold">(</span>ve<span class="ansi-yellow-intense-fg ansi-bold">)</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\utils\validation.py</span> in <span class="ansi-cyan-fg">check_array</span><span class="ansi-blue-intense-fg ansi-bold">(array, accept_sparse, accept_large_sparse, dtype, order, copy, force_all_finite, ensure_2d, allow_nd, ensure_min_samples, ensure_min_features, warn_on_dtype, estimator)</span>
<span class="ansi-green-fg">    560</span>         <span class="ansi-green-intense-fg ansi-bold">if</span> force_all_finite<span class="ansi-yellow-intense-fg ansi-bold">:</span>
<span class="ansi-green-fg">    561</span>             _assert_all_finite(array,
<span class="ansi-green-intense-fg ansi-bold">--&gt; 562</span><span class="ansi-yellow-intense-fg ansi-bold">                                allow_nan=force_all_finite == &#39;allow-nan&#39;)
</span><span class="ansi-green-fg">    563</span> 
<span class="ansi-green-fg">    564</span>     <span class="ansi-green-intense-fg ansi-bold">if</span> ensure_min_samples <span class="ansi-yellow-intense-fg ansi-bold">&gt;</span> <span class="ansi-cyan-intense-fg ansi-bold">0</span><span class="ansi-yellow-intense-fg ansi-bold">:</span>

<span class="ansi-green-intense-fg ansi-bold">~\.conda\envs\Kompensationsarbeit\lib\site-packages\sklearn\utils\validation.py</span> in <span class="ansi-cyan-fg">_assert_all_finite</span><span class="ansi-blue-intense-fg ansi-bold">(X, allow_nan, msg_dtype)</span>
<span class="ansi-green-fg">     58</span>                     msg_err<span class="ansi-yellow-intense-fg ansi-bold">.</span>format
<span class="ansi-green-fg">     59</span>                     (type_err,
<span class="ansi-green-intense-fg ansi-bold">---&gt; 60</span><span class="ansi-yellow-intense-fg ansi-bold">                      msg_dtype if msg_dtype is not None else X.dtype)
</span><span class="ansi-green-fg">     61</span>             )
<span class="ansi-green-fg">     62</span>     <span class="ansi-red-intense-fg ansi-bold"># for object dtype data, we only check for NaNs (GH-13254)</span>

<span class="ansi-red-intense-fg ansi-bold">ValueError</span>: Input contains NaN, infinity or a value too large for dtype(&#39;float64&#39;).</pre>
</div>
</div>
